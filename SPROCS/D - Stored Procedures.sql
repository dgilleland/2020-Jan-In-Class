...
-- @@ERROR is a global variable that contains the error number generated by the last INSERT/UPDATE/DELETE statement. @@ERROR is not changed by doing a SELECT statement. When the INSERT/UPDATE/DELETE is successful, @@ERROR will have a value of zero; otherwise, it will have the value of the specific error number that was generated.
...
AS
    ...
    BEGIN -- {
        ...
        ELSE
        BEGIN -- {
            -- The EXISTS() function checks to see if there are any rows resulting from a quer
    ...
    BEGIN -- {
        ...
        BEGIN -- {
            ...
            BEGIN -- { -- This BEGIN/END is needed, because of two SQL statements
                ...
                VALUES (@Description)
                IF @@ERROR <> 0
                    RAISERROR('Failed to insert new job position', 16, 1)
                ELSE
                -- Send back the database-generated primary key
...
SELECT * FROM Position
EXEC AddPosition 'Remote Instructor'
-- DELETE FROM Position WHERE PositionID = 12
